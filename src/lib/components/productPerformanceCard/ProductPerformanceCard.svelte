...
<div class="flex gap-6 w-3/4 bg-gray-100 rounded-xl">
  <div class="w-3/12">
  ...
  <div class="flex flex-col gap-5 py-3 pr-3 w-3/12">
    <div >
      <img src="http://localhost:3333/static/{produto.imagens[0]}" alt="">
    </div>
